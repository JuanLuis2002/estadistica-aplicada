...
export default function EstadisticaGraficos() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-8 mb-8 md:mb-12">
            <Card className="bg-white/95 backdrop-blur-sm border-0 shadow-2xl hover:shadow-3xl transition-all duration-300">
              <CardHeader className="text-center p-4 md:p-8">
                <div className="relative mb-4 md:mb-6">
                  <div className="w-20 h-20 md:w-32 md:h-32 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-full mx-auto p-1">
                    <img
                  ...
                  <div className="absolute -bottom-1 -right-1 md:-bottom-2 md:-right-2 w-6 h-6 md:w-8 md:h-8 bg-green-500 rounded-full border-2 md:border-4 border-white"></div>
                </div>
                <CardTitle className="text-lg md:text-2xl font-bold text-gray-800 mb-2">
                  Juan Luis Hernandez Hercules
                </CardTitle>
                <CardDescription className="text-sm md:text-lg">
                  <Badge
                    variant="secondary"
                    className="bg-blue-100 text-blue-800 px-3 py-1 md:px-4 md:py-2 text-xs md:text-sm font-semibold"
                  >
                    CIF: 2022010431
                  </Badge>
                </CardDescription>
            ...
            <Card className="bg-white/95 backdrop-blur-sm border-0 shadow-2xl hover:shadow-3xl transition-all duration-300">
              <CardHeader className="text-center p-4 md:p-8">
                <div className="relative mb-4 md:mb-6">
                  <div className="w-20 h-20 md:w-32 md:h-32 bg-gradient-to-br from-indigo-400 to-purple-600 rounded-full mx-auto p-1">
                    <img
                      src="/placeholder.svg?height=128&width=128"
                ...
                <CardDescription className="text-sm md:text-lg">
                  <Badge
                    variant="secondary"
                    className="bg-indigo-100 text-indigo-800 px-3 py-1 md:px-4 md:py-2 text-xs md:text-sm font-semibold"
                  >
                    CIF: 2021010737
                  </Badge>
                </CardDescription>
          ...
          <div className="text-center space-y-4">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl md:rounded-2xl p-4 md:p-8 border border-white/20">
              <h2 className="text-xl md:text-3xl font-bold text-white mb-3">Universidad Evangélica de El Salvador</h2>
              <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 text-blue-100">
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                  <span className="text-sm md:text-lg font-medium">Materia: Estadística Aplicada</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-indigo-400 rounded-full"></div>
                  <span className="text-sm md:text-lg font-medium">Licenciado: Leonel Adonay Guevara Rios</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Footer responsivo */}
      <footer className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-6 md:py-8 mt-12 md:mt-16">
        <div className="max-w-7xl mx-auto px-4 md:px-6 text-center">
          <p className="text-gray-300 text-sm md:text-base">
            © 2024 Universidad Evangélica de El Salvador - Estadística Aplicada
          </p>
          <p className="text-gray-400 text-xs md:text-sm mt-2">Presentación académica sobre Gráficos Estadísticos</p>
        </div>
      </footer>
    </div>
  )
